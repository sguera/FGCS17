...
int main (int argc, char** argv)
{
	...
	if (((X_MAX%8)!=0))
	{
		printf("Non-native, aligned SIMD type mode requires that X_MAX is divisible by 8 [X_MAX = %ld].\n", X_MAX);
		return -1;
	}
	U_0_m1=((float * )malloc(((((X_MAX*Y_MAX)*Z_MAX)*sizeof (float))+31)));
	U_0_m1_ref=((float * )malloc(((((X_MAX*Y_MAX)*Z_MAX)*sizeof (float))+31)));
	if (((X_MAX%8)!=0))
	{
		printf("Non-native, aligned SIMD type mode requires that X_MAX is divisible by 8 [X_MAX = %ld].\n", X_MAX);
		return -1;
	}
	U_0_0=((float * )malloc(((((X_MAX*Y_MAX)*Z_MAX)*sizeof (float))+31)));
	U_0_0_ref=((float * )malloc(((((X_MAX*Y_MAX)*Z_MAX)*sizeof (float))+31)));
	if (((X_MAX%8)!=0))
	{
		printf("Non-native, aligned SIMD type mode requires that X_MAX is divisible by 8 [X_MAX = %ld].\n", X_MAX);
		return -1;
	}
	U_0_1=((float * )malloc(((((X_MAX*Y_MAX)*Z_MAX)*sizeof (float))+31)));
	U_0_1_ref=((float * )malloc(((((X_MAX*Y_MAX)*Z_MAX)*sizeof (float))+31)));
	// <--
...
#pragma omp parallel
	{
		// initialize_grids -->
		initialize_wave_parm(((float * )((((uintptr_t)U_0_m1)+31)&( ~ ((uintptr_t)31)))), ((float * )((((uintptr_t)U_0_0)+31)&( ~ ((uintptr_t)31)))), ((float * )((((uintptr_t)U_0_1)+31)&( ~ ((uintptr_t)31)))), -1.0, (2.0/(X_MAX-3.0)), 0.25, X_MAX, Y_MAX, Z_MAX, cb_x, cb_y, cb_z, chunk);
	...
	{
		// write_grids -->
		write_data_f("U_0_m1.0.data", 3, ((float * )((((uintptr_t)U_0_m1)+31)&( ~ ((uintptr_t)31)))), X_MAX, Y_MAX, Z_MAX);
		write_data_f("U_0_0.0.data", 3, ((float * )((((uintptr_t)U_0_0)+31)&( ~ ((uintptr_t)31)))), X_MAX, Y_MAX, Z_MAX);
		write_data_f("U_0_1.0.data", 3, ((float * )((((uintptr_t)U_0_1)+31)&( ~ ((uintptr_t)31)))), X_MAX, Y_MAX, Z_MAX);
		// <--
...
#pragma omp parallel
	{
		// compute_stencil -->
		wave_parm(( & U_0_1_out), ((float * )((((uintptr_t)U_0_m1)+31)&( ~ ((uintptr_t)31)))), ((float * )((((uintptr_t)U_0_0)+31)&( ~ ((uintptr_t)31)))), ((float * )((((uintptr_t)U_0_1)+31)&( ~ ((uintptr_t)31)))), -1.0, (2.0/(X_MAX-3.0)), 0.25, X_MAX, Y_MAX, Z_MAX, cb_x, cb_y, cb_z, chunk, _unroll_p3);
		// <--
